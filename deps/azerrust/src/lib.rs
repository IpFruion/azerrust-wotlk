...
mod ffi {
    ...
    unsafe extern "C++" {
        ...
        fn GetData(&self, id: u32) -> u32;
        fn GetData64(&self, id: u32) -> u64;
    }
    ...
    unsafe extern "C++" {
        ...
        unsafe fn azerrust_map_get_instance_script(map: &Map) -> *const InstanceScript;
        fn azerrust_instance_script_get_boss_state(script: &InstanceScript, bossId: u32) -> u32;
        fn azerrust_instance_script_check_guid_data(
